  ...
  useEffect(() => { // sayfa açılır açılmaz çalışması gereken yer.
    ...
    const getAllProductCategoryInfo = async () => {
        let response = await axios.get(
            'https://private-9cf980-urunkategorisi2.apiary-mock.com/urunKategorisi'
            );
    
            console.log("getAllProductCategoryInfo" + response.data.UrunKategoriListesi);

            setAllProductCategory(response.data.UrunKategoriListesi);
