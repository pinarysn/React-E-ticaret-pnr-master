...
function YeniSehir() {
  ...
  useEffect(() => { // sayfa açılır açılmaz çalışması gereken yer.
    ...
    const getAllCustomersInfo = async () => {
      ...
      console.log("getAllCustomersInfo" + response.data.SehirListesi);
                    ...
                    <form role="form" className="form-horizontal">
                      <div className="form-body">
                        <div className="form-group form-md-line-input">
                          <label className="col-md-2 control-label" htmlFor="txtName">Sehir</label>
                          <div className="col-md-10">
                            <input required autoComplete="off" type="text" className="form-control" id="txtName" name="txtName" placeholder="Sehir Giriniz.." onChange={e => setCity(e.target.value)} maxLength={50} />
                      ...
                      <div className="form-actions">
                        <div className="row">
                          <div className="col-md-offset-2 col-md-10">
                            <button type="submit" className="btn blue" >KAYDET</button>
